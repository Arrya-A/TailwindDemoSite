      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center text-center lg:text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 sm:px-8 lg:px-16 py-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            <h2 className="text-2xl font-bold mb-2 text-emerald-500">150+</h2>
            <p>happy clients.</p>
          </div>

          {/* Grid 1 */}
          <div className="bg-white p-6 rounded-xl shadow-md">
            <h2 className="text-2xl font-bold mb-2 text-emerald-500">300+</h2>
            <p>successful projects.</p>
          </div>

          {/* Grid 3 */}
          <div className="bg-white p-6 rounded-xl shadow-md">
            <h2 className="text-2xl font-bold mb-2 text-emerald-500">75+</h2>
            <p>satisfied partners.</p>
          </div>

          {/* Grid 4 */}
          <div className="bg-white p-6 rounded-xl shadow-md">
            <h2 className="text-2xl font-bold mb-2 text-emerald-500">100+</h2>
            <p>industry awards.</p>
          </div>
        </div>
      </div>
